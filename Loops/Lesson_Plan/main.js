...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Solution~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//Create an empty or blank array named myWork
var myWork = [];
// Write a for loop that runs from 1 to 10
for (var i = 1; i <= 10; i++) {
    // In each iteration: Create an object representing a lessons hould have a name property, which is a string like "Lesson 1", "Lesson 2", etc and a status property, which alternates between true and false.
    var Lesson = {
        Lesson: "Lesson ".concat(i),
        status: i % 2 === 1 ? true : false //Use a ternary operator to set the status property
    };
    // Step 3: Add the lesson to the array
    myWork.push(Lesson);
}
//Print the result 
console.log("list of lessons", myWork);
