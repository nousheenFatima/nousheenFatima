...
var convertedArr = scrambledArray.map(function (element) { return element.toString(); });
...
var slicedElements = convertedArr.slice(2, 4); // copies from 2 (starting) index to befor index 4
...
console.log("combine elements back into a single string: ".concat(convertedArr.join(" "), "."));
